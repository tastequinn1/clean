        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Opacity(
              opacity: 0.3,
              child: Text(
                arguments['long_message'] ?? "Your order has been successfully submitted, you will receive a confirmation soon".tr,
                textAlign: TextAlign.center,
  ...
  Widget buildBlockButtonWidget() {
    return Container(
      ...
      child: BlockButtonWidget(
          ...
          onPressed: () async {
            await Get.offNamedUntil(shopRoutes.Routes.ORDERS, (Route route) {
