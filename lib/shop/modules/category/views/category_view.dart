      ...
      body: RefreshIndicator(
        onRefresh: () async {
          if (!Get.find<ShopLaravelApiClient>()
              .isLoading(tasks: ['getAllProductsWithPagination', 'getFeaturedProducts', 'getPopularProducts', 'getMostRatedProducts', 'getAvailableProducts'])) {
                            ...
                            return Padding(
                              ...
                              child: RawChip(
                                ...
                                onSelected: (bool value) {
                                  ...
                                  controller.loadProductsOfCategory(controller.category.value.id, filter: controller.selected.value);
                                },
                              ),
                            );
                          });
