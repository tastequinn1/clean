...
class CategoryGridItemWidget extends StatelessWidget {
  ...
  CategoryGridItemWidget({Key? key, required this.category, this.heroTag}) : super(key: key);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if ((category.subCategories.length) > 0) Divider(height: 25, thickness: 0.5,color: Get.theme.dividerColor,),
                  Wrap(
                    spacing: 5,
