...
import '../../global_widgets/top_bar_icon_loader_widget.dart';
              ...
              child: CustomScrollView(
                ...
                slivers: <Widget>[
                  SliverAppBar(
                    ...
                    actions: [
                      if (Get.find<LaravelApiClient>().isLoading(tasks: ['addFavoriteEService', 'removeFavoriteEService'])) TopBarIconLoaderWidget(),
                      if (!Get.find<LaravelApiClient>().isLoading(tasks: ['addFavoriteEService', 'removeFavoriteEService']))
                        IconButton(
                          icon: Container(
                            decoration: BoxDecoration(shape: BoxShape.circle, boxShadow: [
                              BoxShadow(
                            ...
                            child: _eService.isFavorite ? Icon(Icons.favorite, color: Colors.redAccent) : Icon(Icons.favorite_outline, color: Get.theme.hintColor),
                          ),
                          onPressed: () {
                            if (!Get.find<AuthService>().isAuth) {
                              Get.toNamed(Routes.LOGIN);
                            } else {
                              if (_eService.isFavorite) {
                      ...
                      children: [
                        ...
                        EServiceTilWidget(
                          ...
                          content: Obx(() {
                            ...
                            return Ui.applyHtml(_eService.description, style: Get.textTheme.bodyLarge);
                          }),
                        ),
        ...
        children: [
          Row(
            children: [
              ...
              if (!_eService.eProvider.hasData)
                Container(
                  child: Text("  .  .  .  ".tr,
                      maxLines: 1,
              ...
              if (_eService.eProvider.available == false)
                Container(
